...
const Toggle = () => {
  ...
  const getInitialTheme = () => {
    ...
    return currentHour >= 10; // Dark mode enabled after 10 AM
  };
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2 rounded-full bg-gradient-to-tl from-rose-300 via-amber-200 to-amber-100 dark:bg-gradient-to-tl dark:from-rose-300 dark:via-indigo-800 dark:to-indigo-950 transition-all transform hover:scale-110 hover:shadow-lg hover:rotate-360 duration-500 ease-in-out"
    >
      <div
